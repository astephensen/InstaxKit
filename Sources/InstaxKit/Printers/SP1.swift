...
/// Instax SP-1 printer interface (480x640 resolution, JPEG encoding).
public actor SP1: InstaxPrinter {
  public let model: PrinterModel = .sp1
  ...
  public init(host: String = "192.168.0.251", port: UInt16 = 8080, pinCode: UInt16 = 1111) {
    ...
    base = InstaxPrinterBase(model: .sp1, host: host, port: port, pinCode: pinCode)
    imageEncoder = InstaxImageEncoder(model: .sp1)
  }
